...
import lol.turtlecoin.mobilewallet.crypto.EngineFactory;
import lol.turtlecoin.mobilewallet.utils.Bytes;

import static lol.turtlecoin.mobilewallet.crypto.ed25519.Ed25519Constants.B2;
import static lol.turtlecoin.mobilewallet.crypto.ed25519.Ed25519Constants.B_TABLE;
import static lol.turtlecoin.mobilewallet.crypto.ed25519.Ed25519Constants.D;
import static lol.turtlecoin.mobilewallet.crypto.ed25519.Ed25519Constants.D2;
import static lol.turtlecoin.mobilewallet.crypto.ed25519.Ed25519Constants.SQRTM1;
import static lol.turtlecoin.mobilewallet.crypto.ed25519.Field25519.FIELD_LEN;
import static lol.turtlecoin.mobilewallet.crypto.ed25519.Field25519.LIMB_CNT;
...
public final class Ed25519 {
    ...
    public static void reduce32(byte[] s) {
    ...
    public static int sc_check(byte[] s)
    {
        ...
        return (int)((signum(1559614444L - s0)
                + (signum(1477600026L - s1) << 1)
                + (signum(2734136534L - s2) << 2)
                + (signum(350157278L - s3) << 3)
                + (signum(-s4) << 4)
                + (signum(-s5) << 5)
                + (signum(-s6) << 6)
